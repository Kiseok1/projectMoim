	...
	<html>
		<head>
			...
			<body>
				...
				<br>
				<form action="g_notice_info.do" name="lfrm" class="innerbox" method="post" enctype="multipart/form-data">
				<div class="toast">
				...
				<ul class="BoardList">
					<a href="g_notice_info.jsp" >
						<li class="innerList">
							<span class="listtitle">[공지]4.12.0 버전 업데이트 안내</span>
									<img class="barrow" src="./images/paging_next.png" alt="arrow">							
								<br>
				...
				<div class="moreList" aria-hidden="true">
					...
					<!-- 	<h1 id="moreList_font">더보기</h1>
						...
						<a href="g_notice_info.do"><input type="submit" id="load" value="더보기"></a>
					</div>
				</div>	
