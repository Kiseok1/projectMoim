	...
	<html>
		<head>
			...
			<body>
				...
				<br>
				<form action="g_notice.do" name="lfrm" class="innerbox" method="post" enctype="multipart/form-data">
					 <div class="notice-header">
					 	<span class="notice-title" name="l_title">${ndto.l_title }</span>
					 	<span class="notice-date" name="l_date">${ndto.l_date }</span>
					 </div>
					 <br>
					 <div class="notice-content" name="l_content">
					 	<p>${ndto.l_content }</p>
					 	<br>
					 	<br>
