		...
		<head>
			...
			<body>
				...
				<div class="form-group2">	
					<label class="form-label2">지역</label>
					 	<div class="select1">
					 		<input type="text" class="location-text" placeholder="지역을 선택하세요.">
					 	<br>
				...
				<br>
						 <!-- <input type="text" placeholder="정보를 입력하세요." class="form-input6" maxlength="30">	 -->
			...
			<br>
				<div id="input-button">
					...
					<input type="submit" class="submit" value="모임만들기">
				</div>
			<br>
			<br>
