...
public class P_freelistSelectService implements Service {
		...
		public void execute(HttpServletRequest request, HttpServletResponse response) {
			...
			//검색된 게시글 개수
			int listCount = bdao.pfreeListCount(category,sword);
			...
			//전체 게시글 가져오기
			ArrayList<BoardDto> list =  bdao.p_freelistSelect(category,sword,startRow,endRow); 
